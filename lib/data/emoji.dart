...
final List json = jsonDecode(emojiJsonData);
final emojis = json.map<Emoji>((e) => Emoji.fromJson(e)).toList();

Map<String, String> getEmojiInCategory() {
  final map = <String, String>{};
  emojis.forEach((e) {
    if (!map.containsKey(e.category)) map[e.category] = "";
    map[e.category] = map[e.category]! + e.emoji;
  });
  return map;
}
